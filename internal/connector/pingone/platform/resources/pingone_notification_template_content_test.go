...
func TestNotificationTemplateContentExport(t *testing.T) {
	...
	expectedImportBlocks := []connector.ImportBlock{
		...
		},
		{
			...
			ResourceID:   fmt.Sprintf("%s/device_pairing/f50e80bc-e84d-7124-0db5-4fd4cf72d7c9", testutils.GetEnvironmentID()),
		},
		{
			ResourceType: "pingone_notification_template_content",
			ResourceName: "device_pairing_email_fr_a0a13d00_a249_7ad1_3f7e_b6ba77a55955",
			ResourceID:   fmt.Sprintf("%s/device_pairing/a0a13d00-a249-7ad1-3f7e-b6ba77a55955", testutils.GetEnvironmentID()),
		},
		{
			ResourceType: "pingone_notification_template_content",
		...
		},
		{
			...
			ResourceID:   fmt.Sprintf("%s/device_pairing/14651a6a-945b-725b-321f-e13cbe0fd9c6", testutils.GetEnvironmentID()),
		},
		{
			ResourceType: "pingone_notification_template_content",
		...
		},
		{
			...
			ResourceID:   fmt.Sprintf("%s/device_pairing/56b27d33-0110-7670-2c16-f0fca48b6340", testutils.GetEnvironmentID()),
		},
		{
			ResourceType: "pingone_notification_template_content",
		...
		},
		{
			...
			ResourceID:   fmt.Sprintf("%s/device_pairing/2512b56d-e14d-7cbd-3667-e1663d44fa41", testutils.GetEnvironmentID()),
		},
		{
			ResourceType: "pingone_notification_template_content",
		...
		},
		{
			...
			ResourceID:   fmt.Sprintf("%s/general/92adace7-5056-7d40-1c7e-adc71e57cc3f", testutils.GetEnvironmentID()),
		},
		{
			ResourceType: "pingone_notification_template_content",
		...
		},
		{
			...
			ResourceID:   fmt.Sprintf("%s/general/72618f82-18ed-7b7c-19ac-0b5899d92f0c", testutils.GetEnvironmentID()),
		},
		{
			ResourceType: "pingone_notification_template_content",
			ResourceName: "general_email_fr_28524b17_b60b_7fa2_131d_59816ac19864",
			ResourceID:   fmt.Sprintf("%s/general/28524b17-b60b-7fa2-131d-59816ac19864", testutils.GetEnvironmentID()),
		},
		{
			ResourceType: "pingone_notification_template_content",
		...
		},
		{
			...
			ResourceID:   fmt.Sprintf("%s/new_device_paired/a7c11013-ca70-7071-3955-d647568f95d2", testutils.GetEnvironmentID()),
		},
		{
			ResourceType: "pingone_notification_template_content",
		...
		},
		{
			...
			ResourceID:   fmt.Sprintf("%s/new_device_paired/daef917c-3695-7347-1ed0-bb03d80198c2", testutils.GetEnvironmentID()),
		},
		{
			ResourceType: "pingone_notification_template_content",
			ResourceName: "recovery_code_template_email_fr_c558cd3c_eb16_7158_38c3_d87fb2e320f0",
			ResourceID:   fmt.Sprintf("%s/recovery_code_template/c558cd3c-eb16-7158-38c3-d87fb2e320f0", testutils.GetEnvironmentID()),
		},
		{
			ResourceType: "pingone_notification_template_content",
			ResourceName: "recovery_code_template_email_en_dc6755cd_123b_71f6_2fe0_5b74d3789001",
			ResourceID:   fmt.Sprintf("%s/recovery_code_template/dc6755cd-123b-71f6-2fe0-5b74d3789001", testutils.GetEnvironmentID()),
		},
		{
			ResourceType: "pingone_notification_template_content",
		...
		},
		{
			...
			ResourceID:   fmt.Sprintf("%s/strong_authentication/c6de3d50-d766-7533-25cf-bd28f72e2f86", testutils.GetEnvironmentID()),
		},
		{
			ResourceType: "pingone_notification_template_content",
			ResourceName: "strong_authentication_sms_en_5d2b94bc_d264_7f79_048f_a0f062f66d98",
			ResourceID:   fmt.Sprintf("%s/strong_authentication/5d2b94bc-d264-7f79-048f-a0f062f66d98", testutils.GetEnvironmentID()),
		},
		{
			ResourceType: "pingone_notification_template_content",
			ResourceName: "strong_authentication_push_en_b368bc5e_0815_7d16_178c_2631a620e00c",
			ResourceID:   fmt.Sprintf("%s/strong_authentication/b368bc5e-0815-7d16-178c-2631a620e00c", testutils.GetEnvironmentID()),
		},
		{
			ResourceType: "pingone_notification_template_content",
			ResourceName: "strong_authentication_email_fr_2e103d6d_af8e_70fa_282f_91821ed778fd",
			ResourceID:   fmt.Sprintf("%s/strong_authentication/2e103d6d-af8e-70fa-282f-91821ed778fd", testutils.GetEnvironmentID()),
		},
		{
			ResourceType: "pingone_notification_template_content",
		...
		},
		{
			...
			ResourceID:   fmt.Sprintf("%s/strong_authentication/8a888c96-4cb9-7941-0c07-0a4e99a54a04", testutils.GetEnvironmentID()),
		},
		{
			ResourceType: "pingone_notification_template_content",
		...
		},
		{
			...
			ResourceID:   fmt.Sprintf("%s/strong_authentication/e8539132-48c6-7061-1309-f33e99599a3e", testutils.GetEnvironmentID()),
		},
		{
			ResourceType: "pingone_notification_template_content",
		...
		},
		{
			...
			ResourceID:   fmt.Sprintf("%s/transaction/453937a6-e95b-78b9-0d13-be9e17cdda89", testutils.GetEnvironmentID()),
		},
		{
			ResourceType: "pingone_notification_template_content",
		...
		},
		{
			...
			ResourceID:   fmt.Sprintf("%s/transaction/b2509f63-c86c-7f76-0fea-52472af67df2", testutils.GetEnvironmentID()),
		},
		{
			ResourceType: "pingone_notification_template_content",
			ResourceName: "transaction_email_fr_1953c10e_53a9_7c44_13eb_560823acacf6",
			ResourceID:   fmt.Sprintf("%s/transaction/1953c10e-53a9-7c44-13eb-560823acacf6", testutils.GetEnvironmentID()),
		},
		{
			ResourceType: "pingone_notification_template_content",
			ResourceName: "transaction_push_en_926802db_4abb_7369_249a_ff3c63c6a7d1",
			ResourceID:   fmt.Sprintf("%s/transaction/926802db-4abb-7369-249a-ff3c63c6a7d1", testutils.GetEnvironmentID()),
		},
		{
			ResourceType: "pingone_notification_template_content",
			ResourceName: "transaction_email_en_996806a7_0c4e_744c_117b_6312e08225d3",
			ResourceID:   fmt.Sprintf("%s/transaction/996806a7-0c4e-744c-117b-6312e08225d3", testutils.GetEnvironmentID()),
		},
		{
			ResourceType: "pingone_notification_template_content",
			ResourceName: "transaction_sms_en_d9751d12_2f37_7d6e_3cc4_33368770f6da",
			ResourceID:   fmt.Sprintf("%s/transaction/d9751d12-2f37-7d6e-3cc4-33368770f6da", testutils.GetEnvironmentID()),
		},
		{
			ResourceType: "pingone_notification_template_content",
			ResourceName: "transaction_voice_fr_0db4c9f4_c1d6_7adf_1870_22f70f5e95a1",
			ResourceID:   fmt.Sprintf("%s/transaction/0db4c9f4-c1d6-7adf-1870-22f70f5e95a1", testutils.GetEnvironmentID()),
		},
		{
			ResourceType: "pingone_notification_template_content",
