= pingcli identity-cloud api
:created-date: May 15, 2026
:revdate: May 15, 2026
:resourceid: pingcli_command_reference_pingcli_identity-cloud_api

Send a custom REST API request to the management API of PingOne Advanced Identity Cloud.
...
----
pingcli identity-cloud api [flags] API_URI
----

== Examples

----
    Send a custom API request to the configured PingOne Advanced Identity Cloud tenant
----
