# `pingcli davinci variables template`
...
```
pingcli davinci variables template [flags]
```
...
# Generate a template and save to a file
  pingcli davinci variables template > body.json

  # Edit the template, then create the variable
  pingcli davinci variables create --environment-id <env-id> --from-file body.json
...
Example workflow:
  pingcli davinci variables template > body.json
  # edit body.json
  pingcli davinci variables create --from-file body.json
```
