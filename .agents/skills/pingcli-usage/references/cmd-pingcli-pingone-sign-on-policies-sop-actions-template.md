# `pingcli pingone sign-on-policies sop-actions template`
...
```
pingcli pingone sign-on-policies sop-actions template [flags]
```
...
# Generate a template and save to a file
  pingcli pingone sign-on-policies sop-actions template > body.json
...
Example workflow:
  pingcli pingone sign-on-policies sop-actions template > body.json
  # edit body.json
  pingcli pingone sign-on-policies sop-actions create --from-file body.json
```
