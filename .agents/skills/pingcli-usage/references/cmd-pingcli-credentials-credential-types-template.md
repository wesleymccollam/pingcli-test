# `pingcli credentials credential-types template`
...
```
pingcli credentials credential-types template [flags]
```
...
# Generate a template and save to a file
  pingcli credentials credential-types template > body.json
...
Example workflow:
  pingcli credentials credential-types template > body.json
  # edit body.json
  pingcli credentials credential-types create --from-file body.json
```
