# `pingcli authorize application-resource-permissions template`
...
```
pingcli authorize application-resource-permissions template [flags]
```
...
# Generate a template and save to a file
  pingcli authorize application-resource-permissions template > permission.json
...
Example workflow:
  pingcli authorize application-resource-permissions template > body.json
  # edit body.json
  pingcli authorize application-resource-permissions create --from-file body.json
```
