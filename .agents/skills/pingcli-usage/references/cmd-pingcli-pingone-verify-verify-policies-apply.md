# `pingcli pingone verify verify-policies apply`
...
```
pingcli pingone verify verify-policies apply [flags]
```
...
# Create or update a verify policy (body supplies name and required fields)
  pingcli pingone verify verify-policies apply --environment-id <env-id> --from-file verify-policy.json
