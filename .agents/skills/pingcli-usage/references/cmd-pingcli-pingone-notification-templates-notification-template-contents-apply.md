# `pingcli pingone notification-templates notification-template-contents apply`
...
```
pingcli pingone notification-templates notification-template-contents apply [flags]
```
...
# Create or update a notification template content (body must have exactly one delivery-method block)
  pingcli pingone notification-templates notification-template-contents apply --environment-id <env-id> --template-name <template-name> --from-file content.json
