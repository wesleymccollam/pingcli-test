# `pingcli pingone authorize application-resource-permissions create`
...
```
pingcli pingone authorize application-resource-permissions create [flags]
```
...
# Create a new application resource permission from a JSON file
  pingcli pingone authorize application-resource-permissions create --environment-id <env-id> --application-resource-id <app-resource-id> --from-file permission.json
