# `pingcli mfa user-devices delete`
...
```
pingcli mfa user-devices delete [flags]
```
...
```
# Delete a user MFA device
  pingcli mfa user-devices delete --environment-id <env-id> --user-id <user-id> --device-id <device-id>
```
