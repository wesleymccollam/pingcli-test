...
| `pingcli pingone app-role-holder-assignments` | App Role Holder Assignments | [`cmd-pingcli-pingone-app-role-holder-assignments.md`](cmd-pingcli-pingone-app-role-holder-assignments.md) |
| `pingcli pingone app-role-permissions` | Application Role Permissions | [`cmd-pingcli-pingone-app-role-permissions.md`](cmd-pingcli-pingone-app-role-permissions.md) |
...
| `pingcli pingone roles` | Roles | [`cmd-pingcli-pingone-roles.md`](cmd-pingcli-pingone-roles.md) |
